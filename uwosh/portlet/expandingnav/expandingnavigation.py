...
class IExpandingNavigation(IPortletDataProvider):
    ...
    includeTitle = schema.Bool(
            title=_(u"label_include_title", default=u"Include Title"),
            description=_(u"help_include_title",
                          default=u"Whether or not to display the title of the portlet"),
            default=False,
            required=False)
...
class Assignment(base.Assignment):
    implements(IExpandingNavigation)

    title = _(u'Expanding Navigation')
    ...
    def __init__(self, name=u"", includeTitle=False, root=None, currentFolderOnly=False, includeTop=False, topLevel=1, bottomLevel=0):
        self.name = name
...
class EditForm(base.EditForm):
    form_fields = form.Fields(IExpandingNavigation)
    form_fields['root'].custom_widget = UberSelectionWidget
    label = _(u"Edit Expanding Navigation Portlet")
    description = _(u"This portlet display a navigation tree.")
...
class QueryBuilder(object):
    ...
    adapts(Interface, IExpandingNavigation)
